...
export default function Signup() {
  ...
  return (
    <div className="min-h-screen bg-zinc-900 flex items-center justify-center p-4 font-sans">
      <div className="w-full max-w-4xl bg-zinc-900 rounded-[3rem] shadow-2xl overflow-hidden flex relative h-[700px] border border-zinc-800">

        {/* Yellow Decoration Background Element - Flipped for Signup */}
        ...
        <div className="hidden md:flex flex-col justify-center w-1/2 relative z-10 p-12">
          <div className="absolute bottom-10 left-10">
            <h1 className="text-6xl font-black text-white leading-tight tracking-tighter">
              JOIN<br /><span className="text-yellow-400">US</span>
            </h1>
        ...
        <div className="w-full md:w-1/2 bg-zinc-900/90 backdrop-blur-sm relative z-20 flex flex-col justify-center px-12 md:bg-transparent">
          ...
          <div className="mb-10">
            <div className="flex items-center gap-4 text-3xl font-bold mb-2">
              ...
              <Link to="/login" className="text-zinc-600 text-xl font-medium hover:text-white transition-colors">LOGIN</Link>
            </div>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div className="relative group">
              <label className="text-zinc-500 text-xs font-bold uppercase tracking-wider mb-2 block group-focus-within:text-yellow-400 transition-colors">Full Name</label>
              <input
                type="text"
                value={fullName}
            ...
            <div className="relative group">
              <label className="text-zinc-500 text-xs font-bold uppercase tracking-wider mb-2 block group-focus-within:text-yellow-400 transition-colors">Email</label>
              <input
                type="email"
                value={email}
